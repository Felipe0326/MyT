...
import type { RevenueDataset } from '@/features/dashboards/shared/services/revenueService';
...
import { CustomTooltip } from '@/features/dashboards/shared/components/CustomTooltip';
import { SeriesSummary } from '@/features/dashboards/shared/components/SeriesSummary';
...
export const RevenueChart: React.FC<RevenueChartProps> = ({
  ...
  return (
    <ChartContainer
      title={onlyLicencias
        ? "Recaudación de Licencias"
        : onlyRefrendo
          ? "Recaudación de Refrendos"
          : "Comparativa de Recaudación"}
      description={description}
      icon={<DollarSign className="h-5 w-5 text-brand-dark" />}
      controls={onlyLicencias || onlyRefrendo ? undefined : controls}
    >
      {loading ? (
