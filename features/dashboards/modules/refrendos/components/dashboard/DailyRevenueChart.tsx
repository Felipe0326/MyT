...
interface DailyRevenueChartProps {
  ...
  currentMonth: 'jan' | 'feb' | 'mar' | 'abr' | 'may' | 'jun' | 'jul' | 'aug' | 'sep' | 'oct' | 'nov' | 'dec';
...
export const DailyRevenueChart: React.FC<DailyRevenueChartProps> = ({
  ...
  const totalRevenue = data.reduce((acc, curr) => acc + curr.publico + curr.particular, 0);
  ...
  const monthMap = {
    ...
    sep: { name: 'Septiembre', short: 'Sep' },
    oct: { name: 'Octubre', short: 'Oct' },
    nov: { name: 'Noviembre', short: 'Nov' },
    dec: { name: 'Diciembre', short: 'Dic' }
  };
